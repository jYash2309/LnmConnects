...
const EditStory = () => {
    ...
    useEffect(() => {
        ...
        const getStoryInfo = async () => {
            setLoading(true)
            try {
                const { data } = await axios.get(`https://lnmconnect-backend.onrender.com/story/editStory/${slug}`, config)
                setStory(data.data)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.put(`https://lnmconnect-backend.onrender.com/story/${slug}/edit`, formdata, config)
                    ...
                    <div className="Inclusive-editStory-page ">
                        <form onSubmit={handleSubmit} className="editStory-form">
                            ...
                            <div class="currentlyImage">
                                ...
                                <img src={`https://lnmconnect-backend.onrender.com/storyImages/${previousImage}`} alt="storyImage" />
                            </div>
