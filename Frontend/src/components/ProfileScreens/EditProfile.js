...
const EditProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.post(`https://lnmconnect-backend.onrender.com/user/editProfile`, formdata, config)
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="profile-ımg-upld-wrapper">
                    ...
                    <div class="currentImage">
                        ...
                        <img src={`https://lnmconnect-backend.onrender.com/userPhotos/${previousPhoto}`} alt="userPhoto" />
                    </div>
